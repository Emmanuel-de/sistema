                    ...
                    <form method="POST" action="{{ route('digitalizar.update', $digitalizacion->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-check mt-4">
                                            <input class="form-check-input" type="checkbox" id="visor" name="visor" value="1"
                                                   {{ old('visor', $digitalizacion->visor) ? 'checked' : '' }}>
                                            <label class="form-check-label" for="visor">
                                                Visor - Mostrar vista previa de archivos
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control" id="fecha_presentacion" name="fecha_presentacion" 
                                           value="{{ old('fecha_presentacion', $digitalizacion->fecha_presentacion) }}" required>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                            ...
                                            <div class="col-md-6 col-lg-4 mb-3">
                                                <div class="card h-100">
                                                    <div class="card-body text-center">
                                                        ...
                                                        <a href="{{ route('digitalizar.descargarArchivo', [$digitalizacion->id, $index]) }}" 
                                    ...
                                    <div class="alert alert-info mt-3">
                                        ...
                                        <strong>Nota:</strong> Si subes nuevos archivos, los archivos actuales serán reemplazados.
                                    </div>
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="card mb-4">
                            <div class="card-header bg-warning text-dark">
                                <h6 class="mb-0">REEMPLAZAR ARCHIVOS (Opcional)</h6>
                            </div>
                            <div class="card-body">
                                <div class="mb-3">
                                    <label for="archivos" class="form-label">Nuevos archivos:</label>
                                    <input type="file" class="form-control" id="archivos" name="archivos[]" 
                                           multiple accept=".pdf,.jpg,.jpeg,.png,.tiff,.bmp">
                                    <div class="form-text">
                                        <i class="fas fa-info-circle"></i>
                                        Formatos permitidos: PDF, JPG, JPEG, PNG, TIFF, BMP. Máximo 10 archivos de 10MB cada uno.
                                    </div>
                                    @error('archivos')
                                        <div class="text-danger">{{ $message }}</div>
                                    @enderror
